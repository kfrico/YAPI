    ...
    try {
      if (interfaceData.res_body_type === 'json') {
        if (interfaceData.res_body_is_json_schema === true) {
          //json-schema
          let schema = yapi.commons.json_parse(interfaceData.res_body);
          ...
          schema = {
                ...
                "items": {
                  ...
                  "properties": {
                    ...
                    "groupId": {
                      "type": "integer",
                      "format": "int64",
                      "description": "聚合组id 总量 1 温区 2 二级分类 3"
                    },
                    "groupName": {
                      "type": "string",
                      "description": "聚合组名称 总量、温区、二级分类"
                    },
                    "id": {
                      "type": "string"
                    },
                    "installContainerCount": {
                      "type": "integer",
                      "description": "装笼数量",
                      "mock": {
                        "mock": "123"
                    ...
                    "memberId": {
                      "type": "integer",
                      "format": "int64",
                      "description": "聚合成员名称 总量下 pcs 1 cs 2;温区下 冷冻1 冷藏2 常温5 加工7;二级分类下 分类对应id"
                    },
                    "memberName": {
                      "type": "string",
                      "description": "总量下 pcs cs;温区下 冷冻 冷藏 常温 加工;二级分类下 二级分类名称"
                    },
                    "mode": {
                      "type": "integer",
                      "description": "业务模式 1:标品  2:PC加工  3:越库"
                    },
                    "modeName": {
                      "type": "string",
                      "description": "业务模式 1:标品  2:PC加工  3:越库"
            ...
            "title": "ResultVo«List«WaveSummaryVo»»",
            "description": "响应结果",
            "$$ref": "#/definitions/ResultVo«List«WaveSummaryVo»»"
          }
